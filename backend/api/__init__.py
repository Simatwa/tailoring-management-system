...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "tailoring_ms.settings")
import django

django.setup()

from api.v1 import router as v1_router
from tailoring_ms.settings import (
    STATIC_URL,
    MEDIA_URL,
    STATIC_ROOT,
    MEDIA_ROOT,
...
app = FastAPI(
    ...
    license_info={
        "name": "GPLv3 License",
        "url": "https://raw.githubusercontent.com/Simatwa/tailoring-management-system/refs/heads/main/LICENSE",
    },
    docs_url="/api/docs",
    redoc_url="/api/redoc",
